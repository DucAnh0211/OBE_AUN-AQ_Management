...
DECLARE
  ...
  "metadata": {
    ...
    "source_program_version": "V1",
    "generated_date": "2026-09-17",
    "generation_rules": {
      "official_plo_count": 5,
      "minimum_course_plos": "min(credits, 5)",
      "every_clo_has_plo": true,
      "every_course_plo_has_clo": true,
      "many_to_many_enabled": true,
  ...
  "courses_finalized": [
    {
      ...
      "plo_links": [
        ...
        },
        {
          ...
          "weight_code": "Y",
          "progression_code": "I",
          "provenance": "regenerated_v2",
          "fit": "medium",
          "fit_reason": "Bổ sung PLO2 để học phần 3 tín chỉ đủ ba PLO và phản ánh năng lực đề xuất giải pháp kỹ thuật."
        },
        {
          "plo_id": "PLO4",
          "weight_code": "Y",
      ...
      "clos": [
        ...
        {
          "id": "CLO3",
          "text": "Đề xuất và đánh giá quy trình sử dụng ma trận để giải quyết một bài toán kỹ thuật cụ thể.",
          "bloom_level": "C6",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 6
          },
          "assumption_note": "Sinh lại để bảo đảm mọi PLO của học phần được CLO hỗ trợ.",
          "dataset_status": "finalized",
          "supports_plo": [
            "PLO1",
            "PLO2"
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO3",
          "text": "Đề xuất và đánh giá phương pháp đạo hàm hoặc tích phân để giải quyết một bài toán kỹ thuật cụ thể.",
          "bloom_level": "C6",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 7
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO3",
          "text": "Thiết kế và đánh giá phương án giải tích cho một bài toán tối ưu kỹ thuật cụ thể.",
          "bloom_level": "C6",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 8
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO1 và PLO2 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO2",
          "text": "Thực hiện thí nghiệm vật lý, xử lý số liệu và đánh giá độ tin cậy của kết quả đo.",
          "bloom_level": "C4",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 10
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO2",
          "text": "Thực hiện thí nghiệm vật lý nâng cao, xử lý số liệu và đánh giá sai số của kết quả đo.",
          "bloom_level": "C4",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 12
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO3",
          "text": "Thiết kế và đánh giá mô hình rời rạc để giải quyết một bài toán khoa học máy tính cụ thể.",
          "bloom_level": "C6",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 13
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO1 và PLO4 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO2 và PLO5 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO4 và PLO5 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "Cần xác nhận có tình huống gắn với ngành Khoa học máy tính. CLO đồng thời hỗ trợ PLO2 và PLO4 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO2",
          "text": "Xây dựng lộ trình học tập cá nhân và giải thích mối liên hệ giữa các nhóm kiến thức của ngành Khoa học máy tính.",
          "bloom_level": "C4",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 28
    ...
    },
    {
      ...
      "clos": [
        ...
        {
          "id": "CLO2",
          "text": "Tổng hợp quan sát từ môi trường làm việc thực tế và xác định yêu cầu phát triển nghề nghiệp của bản thân.",
          "bloom_level": "C4",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 29
      ...
      "plo_links": [
        {
          ...
          "progression_code": "I",
          "credit_weighted_score": 6,
          "provenance": "rebalanced_v2",
          "fit": "cao",
          "fit_reason": "Nội dung tên môn hoặc liên kết nguồn tương thích trực tiếp với PLO. Trong V2, PLO1 là năng lực hỗ trợ cho đầu ra chuyên ngành chính."
        },
        {
          "plo_id": "PLO3",
          "weight_code": "X",
        ...
        },
        {
          ...
          "provenance": "rebalanced_v2",
          "fit": "cao",
          "fit_reason": "Nội dung tên môn hoặc liên kết nguồn tương thích trực tiếp với PLO. Trong V2, giao tiếp hỗ trợ việc thực hiện đầu ra kỹ thuật chính."
        }
      ],
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO1 và PLO3 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO3 và PLO5 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO1 và PLO5 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
    ...
    },
    {
      ...
      "plo_links": [
        ...
        },
        {
          ...
          "provenance": "regenerated_v2",
          "fit": "medium",
          "fit_reason": "Chuyển đổi số có nội dung lựa chọn và áp dụng giải pháp trí tuệ nhân tạo trong hệ thống số."
        },
        {
          "plo_id": "PLO5",
          "weight_code": "Y",
      ...
      "clos": [
        ...
        {
          "id": "CLO4",
          "text": "Đề xuất phương án ứng dụng trí tuệ nhân tạo cho một bài toán chuyển đổi số và đánh giá tính khả thi của phương án.",
          "bloom_level": "C6",
          "provenance": "generated_for_v2_constraints",
          "source_reference": {
            "source_row": 43
      ...
      "clos": [
        {
          ...
          "dataset_status": "finalized",
          "assumption_note": "CLO đồng thời hỗ trợ PLO2 và PLO3 trong phạm vi học phần."
        },
        {
          "id": "CLO2",
    ...
    },
    {
      ...
      "plo_links": [
        ...
        },
        {
          ...
          "provenance": "rebalanced_v2",
          "fit": "cao",
          "fit_reason": "Nội dung tên môn hoặc liên kết nguồn tương thích trực tiếp với PLO. Trong V2, ứng dụng AI là đầu ra trọng tâm của học phần."
        }
      ],
      "clos": [
        {
  ...
  "plo_balance": {
    ...
    "alert_threshold": 0.2,
    "alerts": [],
    "balance_status": "within_20_percent"
  },
  "validation_summary": {
    "program_plos": 5,
    "courses": 59,
    ...
    "clo_plos": 210,
    "multi_plo_clos": 55,
    "credit_rule_violations": [],
    "uncovered_course_plos": [],
    "clos_without_plos": [],
    "invalid_clo_plos": [],
    "duplicate_clo_courses": [],
    "courses_below_two_clos": [],
    "balance": {
      "formula": "sum(course_credits * (2 if X else 1 if Y else 0))",
      "final_scores": {
        "PLO1": 160,
...
$obe_v2_0$::jsonb;
    v_json_sha text := 'cb057908396aa8fc4ed0ee3125f4824cda858e9b1bce5c1feeebbc9993455b8c';
    v_program_id bigint;
    v_v1_id bigint;
    v_v2_id bigint;
...
BEGIN
    ...
    VALUES ('PLO_CLO_59_mon_v2.json', 'json', v_json_sha)
