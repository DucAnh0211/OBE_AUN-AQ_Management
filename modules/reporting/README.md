...
Public entry points là frontend/index.ts, backend/index.ts và ai/__init__.py.
Module dùng Curriculum và Accreditation qua public contracts, không import
repository hoặc implementation nội bộ.
