...
public static class AccreditationModule
{
    ...
    public static IEndpointRouteBuilder MapAccreditationModule(this IEndpointRouteBuilder endpoints)
    {
        var group = endpoints.MapGroup(Descriptor.ApiPrefix).WithTags("Accreditation")
            .RequireAuthorization(AuthorizationPolicies.AdminOrLecturer);
        ...
        group.MapGet("/frameworks", async (AccreditationService service, ICurrentUser user, CancellationToken ct, string? status=null, string? q=null)
            => Results.Ok(await service.GetFrameworksAsync(user.Role==SystemRoles.Admin?status:"published",q,ct)));
        group.MapGet("/frameworks/{id:long:min(1)}", async (long id, AccreditationService service, IAccessControlService access, CancellationToken ct)
            => await access.CanReadFrameworkAsync(id,ct)?Results.Ok(await service.GetFrameworkAsync(id,ct)):Results.Forbid()).WithName("GetAunFramework");
        group.MapGet("/frameworks/{id:long:min(1)}/tree", async (long id, AccreditationService service, IAccessControlService access, CancellationToken ct, string? language=null)
            => await access.CanReadFrameworkAsync(id,ct)?Results.Ok(await service.GetTreeAsync(id,language,ct)):Results.Forbid());
        ...
        group.MapPut("/frameworks/{id:long:min(1)}", async (long id,UpdateFrameworkRequest request,AccreditationService service,CancellationToken ct)
            => {await service.UpdateFrameworkAsync(id,request,ct);return Results.Ok(await service.GetFrameworkAsync(id,ct));}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapDelete("/frameworks/{id:long:min(1)}", async (long id, AccreditationService service, CancellationToken ct)
            => { await service.DeleteFrameworkAsync(id,ct); return Results.NoContent(); }).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPost("/frameworks/{id:long:min(1)}/criteria", async (long id, CriterionRequest request, AccreditationService service, CancellationToken ct)
            => Results.Created($"{Descriptor.ApiPrefix}/frameworks/{id}/tree",new{id=await service.AddCriterionAsync(id,request,ct)})).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPut("/frameworks/{id:long:min(1)}/criteria/{criterionId:long:min(1)}", async (long id,long criterionId,CriterionRequest request,AccreditationService service,CancellationToken ct)
            => {await service.UpdateCriterionAsync(id,criterionId,request,ct);return Results.NoContent();}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapDelete("/frameworks/{id:long:min(1)}/criteria/{criterionId:long:min(1)}", async (long id,long criterionId,AccreditationService service,CancellationToken ct)
            => {await service.DeleteCriterionAsync(id,criterionId,ct);return Results.NoContent();}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPost("/frameworks/{id:long:min(1)}/criteria/{criterionId:long:min(1)}/requirements", async (long id,long criterionId,RequirementRequest request,AccreditationService service,CancellationToken ct)
            => Results.Created($"{Descriptor.ApiPrefix}/frameworks/{id}/tree",new{id=await service.AddRequirementAsync(id,criterionId,request,ct)})).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPut("/frameworks/{id:long:min(1)}/requirements/{requirementId:long:min(1)}", async (long id,long requirementId,RequirementRequest request,AccreditationService service,CancellationToken ct)
            => {await service.UpdateRequirementAsync(id,requirementId,request,ct);return Results.NoContent();}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapDelete("/frameworks/{id:long:min(1)}/requirements/{requirementId:long:min(1)}", async (long id,long requirementId,AccreditationService service,CancellationToken ct)
            => {await service.DeleteRequirementAsync(id,requirementId,ct);return Results.NoContent();}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPost("/framework-imports/preview", (FrameworkImportRequest request, AccreditationService service)
            => Results.Ok(service.PreviewImport(request))).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        ...
        group.MapPost("/frameworks/{id:long:min(1)}/publish", async (long id,AccreditationService service,CancellationToken ct)
            => {await service.PublishAsync(id,ct);return Results.Ok(await service.GetFrameworkAsync(id,ct));}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPost("/frameworks/{id:long:min(1)}/retire", async (long id,AccreditationService service,CancellationToken ct)
            => {await service.RetireAsync(id,ct);return Results.Ok(await service.GetFrameworkAsync(id,ct));}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPut("/frameworks/{id:long:min(1)}/criteria/{criterionId:long:min(1)}/translations/{language}", async (long id,long criterionId,string language,TranslationText request,AccreditationService service,CancellationToken ct)
            => {await service.UpsertCriterionTranslationAsync(id,criterionId,language,request,ct);return Results.NoContent();}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        group.MapPut("/frameworks/{id:long:min(1)}/requirements/{requirementId:long:min(1)}/translations/{language}", async (long id,long requirementId,string language,TranslationText request,AccreditationService service,CancellationToken ct)
            => {await service.UpsertRequirementTranslationAsync(id,requirementId,language,request,ct);return Results.NoContent();}).RequireAuthorization(AuthorizationPolicies.AdminOnly);
        return endpoints;
    }
}
